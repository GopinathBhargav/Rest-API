...
public class Hooks{
	...
	public void runbefore(Scenario scenario)
	{
		...
		System.out.println("========================== before each scenario in feature =================");
		 ...
		 * reporter.config().setReportName("API test cases"); extent = new
		 * ExtentReports(); extent.attachReporter(reporter);
		 * extent.setSystemInfo("Tester","Gopi"); test = extent.createTest(testcase)
		 */;
	...
	public void runafter(Scenario scenario) {
	    System.out.println("------------- after each scenario in feature -----------------");
	    System.out.println(scenario.getName() + " Status - " + scenario.getStatus());
		/*
		 * String s = scenario.getStatus();
		 * 
		 * if(s.equalsIgnoreCase("passed")) { test.log(Status.PASS, "test case passed");
		 * }
		 * 
		 * extent.flush();
		 */
